...
water_progress::water_progress(QWidget *parent /* = nullptr */)
    :QWidget(parent)
{
...
void water_progress::paintEvent(QPaintEvent * event)
{
    Q_UNUSED(event);
...
void water_progress::timerEvent(QTimerEvent * event)
{
    Q_UNUSED(event);
    this->update();
}

void water_progress::drawValue(QPainter * painter)
{
    Q_UNUSED(painter);
    // 反锯齿;
