...
class water_progress : public QWidget
{
    Q_OBJECT

public:
    explicit water_progress(QWidget *parent = nullptr);
    ~water_progress();
...
private:
   ...
   QColor m_boderColor = QColor(226, 234, 244);
//    QColor m_bgColor = QColor(226, 234, 244);
QColor m_bgColor = QColor(217, 225, 237);
   QFont m_font;
   int m_value = 50;
   int m_minValue = 0;
   int m_maxValue = 100;
