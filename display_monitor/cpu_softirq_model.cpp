...
namespace monitor
{
  ...
  MonitorBaseModel::MonitorBaseModel(QObject *parent) : MonitorInterModel(parent)
  {
    header_ << tr("cpu");
    header_ << tr("hi");
    header_ << tr("timer");
  ...
  void MonitorBaseModel::UpdateMonitorInfo(const monitor::proto::MonitorInfo &monito_info)
  {
    beginResetModel();
    monitor_data_.clear();
  ...
  vector<QVariant> MonitorBaseModel::insert_one_soft_irq(const monitor::proto::SoftIrq &soft_irq)
  {
